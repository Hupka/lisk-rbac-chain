...
export const ProfileIcon: React.FC<{ signedIn: boolean }> = props => {
	return (
		<>
			{props.signedIn ? (
				<Menu.Button className="bg-white border-2 border-gray-200 rounded-full flex text-sm ring-2 ring-white ring-opacity-20 focus:outline-none focus:ring-opacity-100">
